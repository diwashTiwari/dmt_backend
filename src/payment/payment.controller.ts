...
import { EnumEventType, PaymentContext, PaymentSetting, Prisma } from '@prisma/client';
...
export class PaymentController {
  ...
  async createOrderForSellerBoostingEvent(
    ...
    const createEventBoosterBuyerHistoryDto = new CreateEventBoosterBuyerHistoryDto();
